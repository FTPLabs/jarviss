<script lang="ts">
      ...
      const TELEGRAM_HANDLE = "@ftpdev_sup"
      const TELEGRAM_URL = "https://t.me/ftpdev_sup"
  ...
  <footer id="footer">
      <p>© {COPYRIGHT_YEAR}. {t('footer-author')}: <b>{authorName}</b></p>
      <p class="links">
          <a href={TELEGRAM_URL} target="_blank" class="telegram-link">
